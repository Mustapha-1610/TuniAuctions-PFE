...
export function emailChangeRequestTemplate(secretCode: string) {
...
We ve received a request to change the email for your Tuni-Auctions account. To proceed with this change, please use the security code provided below. This code is designed to verify your identity and protect your account from unauthorized access. If you did not initiate this request, please ignore this email or contact us immediately for support.
</p>    
<div style="background-color: #000; margin-top: 32px; height: 1px;"></div>
