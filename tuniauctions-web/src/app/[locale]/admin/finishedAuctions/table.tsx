...
interface Props {
  finishedAuctions: AuctionListingType[];
}
export default function FinsihedAuctionsTable({ finishedAuctions }: Props) {
  useEffect(() => {}, [finishedAuctions]);
  const {
    setAuction,
